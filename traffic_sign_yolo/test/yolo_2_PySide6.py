...
class YOLOGUI(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(100, 100, 1000, 850)  # Điều chỉnh kích thước cửa sổ về 1000x850
        self.setStyleSheet("""
            QMainWindow {
    ...
    def _build_ui(self):
        ...
        self.video_panel.setStyleSheet("""
            ...
            border-radius: 5px;
        """)
        self.video_panel.setMinimumSize(600, 450)  # Giảm kích thước video xuống 600x450
    ...
    def snapshot(self):
        if self.processed_frame is not None:
            ...
            QMessageBox.information(self, "Đã lưu", f"Ảnh đã lưu: {os.path.abspath(fn)}")
        else:
